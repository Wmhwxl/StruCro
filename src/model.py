...
class BindingModel(nn.Module):
    ...
    def __init__(self,
        ...
        # build transformation layer based on transformers  n_layer=6
    ...
    def forward(self, 
        ...
        **kwargs,
        ...
        head_input_embs = head_input_embs.unsqueeze(1) # (batch_size, 1, hidden_dim)
        #print(head_input_embs)
        #print(rel_type_emb)
    ...
    def _groupby_and_project(self, head_emb, head_type_ids):
        ...
        """
        # groupby batch sample index by head_type_ids根据id类型进行分组然后进行映射
